...
class General(commands.Cog):
    ...
    async def help(self, ctx):
        ...
        lines = [
            ...
            f"  {p}persona [user]     set/clear/show a per-user persona",
            ...
            f"  {p}image ls           list bot pictures",
            f"  {p}image upload       upload a picture (attach file)",
            f"  {p}image download [n]  download a picture from folder",
