...
class General(commands.Cog):
    ...
    async def help(self, ctx):
        ...
        lines = [
            ...
            f"  {p}instructions             upload a new instructions.txt",
            ...
            "─────────────────────────────",
            "  🔊  Voice",
            f"  {p}join <channel_id>        join a voice channel",
            f"  {p}leave                    leave current voice channel",
            f"  {p}autojoin <channel_id>    set voice channel to auto-join",
